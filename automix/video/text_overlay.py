...
class LyricsRenderer:
    ...
    def get_lyrics_at_time(self, time_seconds: float) -> Optional[str]:
        """指定時刻の歌詞を取得"""
    ...
    def render_karaoke(
        ...
        if highlighted:
            ...
            result = self.text_overlay.add_text(
                result, highlighted, (x, y), style=style
            )
