            ...
            class WebProgress:
                ...
                def update(self, task_id, advance):
                    if 0 <= task_id < len(self.tasks):
                        ...
                        # 全体の進捗を計算
                        total_progress = sum(
                            t['completed'] / t['total'] for t in self.tasks
                        ) / len(self.tasks) * 100
    ...
    presets = [
        {
            'id': 'pop',
            'name': 'Pop',
            'description': 'Bright and vocal-forward mix'
        },
        {
            'id': 'rock',
            'name': 'Rock',
            'description': 'Powerful and balanced mix'
        },
        {
            'id': 'ballad',
            'name': 'Ballad',
            'description': 'Warm and vocal-focused mix'
        }
    ]
