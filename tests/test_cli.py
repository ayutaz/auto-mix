...
class TestProcessAudio:
    ...
    def mock_dependencies(self):
        """依存関係のモック"""
        with patch("automix.cli.AudioLoader") as mock_loader, \
    ...
    def test_process_audio_basic(self, mock_dependencies):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("automix.cli.Progress") as mock_progress:
                process_audio(
                    vocal_path, bgm_path, output_path,
                    settings, mock_progress.return_value, False
                )
    ...
    def test_process_audio_verbose_mode(self, mock_dependencies):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("automix.cli.Progress") as mock_progress, \
                ...
                process_audio(
                    vocal_path, bgm_path, output_path,
                    settings, mock_progress.return_value, True
                )
...
class TestGenerateVideo:
    ...
    def test_generate_video_basic(self):
        """基本的なビデオ生成のテスト"""
        with patch("automix.cli.VideoSettings") as mock_settings, \
            ...
            mock_visualizer.return_value.render_composite_frame.return_value = np.zeros((1080, 1920, 3), dtype=np.uint8)
...
class TestDisplayAnalysisResults:
    ...
    def test_display_analysis_results(self):
        ...
        with patch("automix.cli.console") as mock_console, \
             patch("automix.cli.Table") as mock_table:
